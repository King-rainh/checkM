        ...
        <form action="<%=ctxPath%>/question/list.do" method="post">
            ...
            <label class="checkbox-inline">
                <input type="radio" name="condition" value="allUnresolved" 
                    <c:if test="${condition=='allUnresolved' }">checked="checked"</c:if> />解决中
            </label>
            <label class="checkbox-inline">
                <input type="radio" name="condition" value="allResolved" 
                    <c:if test="${condition=='allResolved' }">checked="checked"</c:if> />已解决
            </label>
            <label class="checkbox-inline">
                <input type="radio" name="condition" value="myAsked" 
                    <c:if test="${condition=='myAsked' }">checked="checked"</c:if> />我提问的问题
            </label>
            <label class="checkbox-inline" >
                <input type="radio" name="condition" value="myAnswered" 
                    <c:if test="${condition=='myAnswered' }">checked="checked"</c:if> />我回复的问题
            </label>
            ...
            <c:forEach items="${pageInfo.list }" var="question">
                <div class="panel panel-default"> 
                    <div class="panel-body"> 
                            <a href="<%=ctxPath%>/question/detail.do?questionId=${question.id}" target="_blank"> 
