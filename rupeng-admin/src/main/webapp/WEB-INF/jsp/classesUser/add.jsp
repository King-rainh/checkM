...
<div class="pd-20">
	<div class="text-c">
        <form action="<%=ctxPath%>/classesUser/listUser.do">
            ...
            <tbody>
                <c:forEach items="${pageInfo.list }" var="user">
                    <tr>
                        ...
                        <td>${user.phone }</td>
                        <td>
                            <button class="btn size-M radius" onclick="ajaxSubmit('<%=ctxPath%>/classesUser/add.do','userId=${user.id}&classesId=${classesId }')">添加到班级</button>
                        </td>
                    </tr>
                </c:forEach>
